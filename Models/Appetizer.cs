...
{
	internal class Appetizer : MenuItem
	{
		public static string Category { get; } = "Appetizer";
		public Appetizer(string name, string description, decimal price, System.Data.Linq.Binary image) : base(name,description,price,image) { }
