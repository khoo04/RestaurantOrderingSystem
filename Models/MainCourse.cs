...
{
	internal class MainCourse : MenuItem
	{
		public static string Category { get; } = "Main Course";
		public MainCourse(string name, string description, decimal price, Binary image) : base(name, description, price, image)
		{
		}
