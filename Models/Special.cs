...
{
	internal class Special : MenuItem
	{
		public static string Category { get; } = "Special";
		public Special(string name, string description, decimal price, Binary image) : base(name, description, price, image)
		{
		}
