...
namespace RestaurantOrderingSystem.Forms
{
	public partial class SpecialForm : Form
	{
		...
		public SpecialForm(IEnumerable<Menu> appertizerItems, AddItemCallBack addItemCallBack)
		{
			InitializeComponent();
			...
			{
				comboBoxSpecial.Items.Add(item.name);
			}
		}

		private void comboBoxSpecial_SelectedIndexChanged(object sender, EventArgs e)
		{
			string itemSelected = comboBoxSpecial.SelectedItem.ToString();
